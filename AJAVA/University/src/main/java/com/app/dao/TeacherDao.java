...
public class TeacherDao {
	...
	public static boolean validateUniversityResult(UniversityResult u)
	        throws ClassNotFoundException, SQLException {

	    Connection con = getConnection();

	    System.out.println("Searching in DB for PRN = " + u.getPrn());

	    PreparedStatement pstmt =
	            con.prepareStatement(
	            "select * from tresult where prn=?");
	...
	public static boolean getStudentResult(
	        UniversityResult u)
	        throws ClassNotFoundException, SQLException {
