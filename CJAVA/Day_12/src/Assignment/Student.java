...
public class Student {
	...
	public static void main(String[] args)
	{
		...
		for(int i=0; i<3 ;i++)
		{
			...
			l.add(new Student(id, name, department, marks));
		...
		l.stream().sorted(Comparator.comparing(Student::getMarks).reversed()).forEach(System.out::println);
		
		System.out.println("---------------------- Map ---------------------");
		Map <String,List<Student>> m = l.stream().collect(Collectors.groupingBy(Student::getDept));
