...
public class Student {
	...
	public static void main(String[] args) {
		...
		Student[] gr0to50 = new Student[10];
		Student[] gr50to65 = new Student[10];
		Student[] gr65to80 = new Student[10];
		Student[] gr80to100 = new Student[10];
		...
		printGroup("Group 0-50 ", gr0to50, c1);
		printGroup("Group 50-65 ", gr50to65, c2);
		printGroup("Group 65-80 ", gr65to80, c3);
		printGroup("Group 80-100 ", gr80to100, c4);
